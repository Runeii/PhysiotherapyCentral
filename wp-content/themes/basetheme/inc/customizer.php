...
function skt_construction_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'logo_sec', array(
            'title' => __('Logo (PRO Version)', 'skt-construction'),
            'priority' => 1,
 			'description' => sprintf( __( 'Logo Settings available in <br /> %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'skt-construction' )
						)
					),			
        )
    );  
    $wp_customize->add_setting('skt_construction_options[logo-info]',array(
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field'
        )
    );
    $wp_customize->add_control( new skt_construction_Info( $wp_customize, 'logo_section', array(
        'section' => 'logo_sec',
        'settings' => 'skt_construction_options[logo-info]',
        'priority' => null
        ) )
    );
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control($wp_customize,'color_scheme',array(
			'label' => __('Color Scheme','skt-construction'),
 			'description' => sprintf( __( 'More color options in <br /> %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'skt-construction' )
						)
					),			
			'section' => 'colors',
...
// Home Second Section 	
	...
	$wp_customize->add_section(
        ...
        array(
            ...
            'priority' => null,
            'description' => sprintf( __( 'Featured Image Size Should be ( 1400x571 ) More slider settings available in %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'skt-construction' ))),			
        )
    );
	...
	$wp_customize->add_section('social_sec',array(
			'title'	=> __('Social Settings','skt-construction'),
	 		'description' => sprintf( __( 'More social icon available in <br />  %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'skt-construction' )
						)
					),				
			'priority'		=> null
	));
	...
	$wp_customize->add_section('footer_area',array(
			...
			'priority'	=> null,
	 		'description' => sprintf( __( 'To remove credit &amp; copyright text upgrade to <br />  %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'skt-construction' )
						)
					) 
	));
	...
	$wp_customize->add_section( 'theme_layout_sec', array(
            'title' => __('Layout Settings (PRO Version)', 'skt-construction'),
            'priority' => null,
	 		'description' => sprintf( __( 'Layout Settings available in <br />  %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'skt-construction' )
						)
					),			
        )
    );  
    $wp_customize->add_setting('skt_construction_options[layout-info]', array(
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field'
        )
    );
    $wp_customize->add_control( new skt_construction_Info( $wp_customize, 'layout_section', array(
        'section' => 'theme_layout_sec',
        'settings' => 'skt_construction_options[layout-info]',
        'priority' => null
        ) )
    );
	
	$wp_customize->add_section('theme_font_sec', array(
            'title' => __('Fonts Settings (PRO Version)', 'skt-construction'),
            'priority' => null,
	 		'description' => sprintf( __( 'Font Settings available in <br />  %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'skt-construction' )
						)
					),			
        )
    );  
    $wp_customize->add_setting('skt_construction_options[font-info]', array(
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field'
        )
    );
    $wp_customize->add_control( new skt_construction_Info( $wp_customize, 'font_section', array(
        'section' => 'theme_font_sec',
        'settings' => 'skt_construction_options[font-info]',
        'priority' => null
        ) )
    );
	
    $wp_customize->add_section( 'theme_doc_sec', array(
            'title' => __('Documentation &amp; Support', 'skt-construction'),
            'priority' => null,
	 		'description' => sprintf( __( 'For documentation and support check this link :  %s.', 'skt-construction' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_THEME_DOC.'"' ), __( 'Skt Construction Documentation', 'skt-construction' )
						)
					),				
        )
    );  
    $wp_customize->add_setting('skt_construction_options[info]', array(
            'type' => 'info_control',
            'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field'
        )
    );
    $wp_customize->add_control( new skt_construction_Info( $wp_customize, 'doc_section', array(
        'section' => 'theme_doc_sec',
        'settings' => 'skt_construction_options[info]',
        'priority' => 10
        ) )
    );		
}
