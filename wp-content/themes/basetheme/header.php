                ...
                <div class="logo">
                 ...
                 <div class="headerright">                 
                   <?php if ( ! dynamic_sidebar('sidebar-header')): ?>
                    ...
                    <span class="headerphone"><?php _e('0789 256 321','skt-construction'); ?></span><br>
                    <span class="headreemail"><a href="mailto:info@buildpress.com"><?php _e('info@buildpress.com','skt-construction'); ?></a></span>
                    <div class="clear"></div>
                    </div>
                    
                    <div class="column-2">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/icon-home.jpg" alt="" />                 
                    <span class="headerphone"><?php _e('Street 238, Perth,','skt-construction'); ?></span><br>
                    <span class="headreemail"><?php _e('Western Australia','skt-construction'); ?></span>
                    <div class="clear"></div>
                    </div>
                  <?php endif; ?>  
                   <div class="column-3">
                 ...
                 <div class="clear"></div>
                <div class="toggle">
                <a class="toggleMenu" href="#"><?php _e('Menu','skt-construction'); ?></a>
                </div><!-- toggle -->
                <div class="nav">                  
